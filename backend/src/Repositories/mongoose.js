...
var uri = process.env.connectionstring3;
if (!uri) {
    throw new Error("A variável de ambiente connectionstring não foi definida.");
}
var Device_MongoClient = new mongodb_1.MongoClient(uri, {
    tls: true,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Device_MongoClient.connect()];
                case 1:
                    _a.sent();
                    isConnected = true;
                    ...
                    _a.label = 2;
                case 2: return [2 /*return*/, Device_MongoClient];
            }
        });
    });
}
exports.default = Device_MongoClient;
